n8n AI Automation Engineering — Learning Workflow Library
Official companion repository for the n8n AI Automation Apprenticeship
Paste the system prompt into Claude , Get a senior engineer as your coach , Build real systems that real clients pay for.
...
1. Import
Open your n8n instance (self-hosted on Render or cloud).
Go to Workflows , Import from File.
Select any .json file from the learning-workflows/ folder.
n8n recreates the full workflow — nodes, connections, and layout.
...
3. Activate and test
Click Save, then Activate (for webhook workflows).
Send a test payload using hoppscotch.io or the built-in test button.
Verify the result in your Slack channel, Supabase table, or Google Sheet.
...
Related
The Apprenticeship: Gumroad product page
n8n Docs: docs.n8n.io
Free APIs: Gemini | Groq | Supabase
"A workflow that works once is not a product. A workflow that works reliably at scale, can be maintained by someone other than you, and does not break when requirements change — that is what clients pay for repeatedly and refer others for."
— Principle 1 of this apprenticeship
